...
public class NumberOf1Bits {
    ...
    public static void main(String[] args) {
        System.out.println(new NumberOf1Bits().hammingWeight(0b00000000000000000000000000001011));
        System.out.println(new NumberOf1Bits().hammingWeight(0b00000000000000000000000010000000));
